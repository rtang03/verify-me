import type { IDataStoreGetVerifiablePresentationArgs } from '@veramo/core';
...
const handler: NextApiHandler = async (req, res) => {
  if (req.method === 'GET') {
    ...
    const url = `${getTenantUrl(slug, domain, secure)}/agent/dataStoreGetVerifiablePresentation`;
    const args: IDataStoreGetVerifiablePresentationArgs = { hash };
