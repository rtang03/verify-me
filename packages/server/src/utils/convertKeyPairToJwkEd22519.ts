...
export const convertKeyPairsToJwkEd22519: (
  publicKeyHex: string,
  ...
  return privateKeyHex
    ? {
        publicKeyJwk: <JWK>{ kty: 'OKP', crv: 'Ed25519', alg: 'EdDSA', kid: publicKeyHex, x },
        privateKeyJwk: <JWK>{ kty: 'OKP', crv: 'Ed25519', alg: 'EdDSA', kid: publicKeyHex, x, d },
      }
    : {
        publicKeyJwk: <JWK>{ kty: 'OKP', crv: 'Ed25519', alg: 'EdDSA', kid: publicKeyHex, x },
      };
