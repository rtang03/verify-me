 ...
 * @see https://github.com/uport-project/veramo/blob/next/packages/data-store/src/migrations/1.createDatabase.ts
 */
export const createVeramo1447159020001 = (database: string, schema: string) => {
  return class Veramo1447159020001 implements MigrationInterface {
    async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.createTable(
        new Table({
          schema,
          database,
          name: 'presentation_verifier_identifier',
          columns: [
      ...
      await queryRunner.createTable(
        new Table({
          schema,
          database,
          name: 'presentation_credentials_credential',
          columns: [
            { name: 'presentationHash', type: 'varchar', isPrimary: true },
      ...
      await queryRunner.createTable(
        new Table({
          schema,
          database,
          name: 'message_presentations_presentation',
          columns: [
      ...
      await queryRunner.createTable(
        new Table({
          schema,
          database,
          name: 'message_credentials_credential',
          columns: [
            { name: 'messageId', type: 'varchar', isPrimary: true },
            { name: 'credentialHash', type: 'varchar', isPrimary: true },
          ],
